...
#include "expidus-settings-marshal.h"



struct _ExpidusSettingsCellRendererClass
{
    GtkCellRendererClass __parent__;
};

struct _ExpidusSettingsCellRenderer
{
...
static void             expidus_settings_cell_renderer_set_property  (GObject              *object,
                                                                   guint                 prop_id,
                                                                   const GValue         *value,
                                                                   GParamSpec           *pspec);
static void             expidus_settings_cell_renderer_get_property  (GObject              *object,
                                                                   guint                 prop_id,
                                                                   GValue               *value,
                                                                   GParamSpec           *pspec);
static void             expidus_settings_cell_renderer_finalize      (GObject              *object);
static void             expidus_settings_cell_renderer_render        (GtkCellRenderer      *cell,
                                                                   cairo_t              *cr,
                                                                   GtkWidget            *widget,
                                                                   const GdkRectangle   *background_area,
                                                                   const GdkRectangle   *cell_area,
                                                                   GtkCellRendererState  flags);
static gint             expidus_settings_cell_renderer_activate      (GtkCellRenderer      *cell,
                                                                   GdkEvent             *event,
                                                                   GtkWidget            *widget,
                                                                   const gchar          *path,
                                                                   const GdkRectangle   *background_area,
                                                                   const GdkRectangle   *cell_area,
                                                                   GtkCellRendererState  flags);
static GtkCellEditable *expidus_settings_cell_renderer_start_editing (GtkCellRenderer      *cell,
                                                                   GdkEvent             *event,
                                                                   GtkWidget            *widget,
                                                                   const gchar          *path,
                                                                   const GdkRectangle   *background_area,
                                                                   const GdkRectangle   *cell_area,
                                                                   GtkCellRendererState  flags);
static void             expidus_settings_strv_to_string              (const GValue         *src_value,
                                                                   GValue               *dest_value);


G_DEFINE_TYPE (ExpidusSettingsCellRenderer, expidus_settings_cell_renderer, GTK_TYPE_CELL_RENDERER)



static void
expidus_settings_cell_renderer_class_init (ExpidusSettingsCellRendererClass *klass)
{
    GObjectClass         *gobject_class;
    GtkCellRendererClass *gtkcellrenderer_class;

    gobject_class = G_OBJECT_CLASS (klass);
    gobject_class->set_property = expidus_settings_cell_renderer_set_property;
    gobject_class->get_property = expidus_settings_cell_renderer_get_property;
    gobject_class->finalize = expidus_settings_cell_renderer_finalize;

    gtkcellrenderer_class = GTK_CELL_RENDERER_CLASS (klass);
    gtkcellrenderer_class->render = expidus_settings_cell_renderer_render;
    gtkcellrenderer_class->activate = expidus_settings_cell_renderer_activate;
    gtkcellrenderer_class->start_editing = expidus_settings_cell_renderer_start_editing;
    ...
    renderer_signals[VALUE_CHANGED] = g_signal_new (g_intern_static_string ("value-changed"),
                                                    ...
                                                    G_SIGNAL_RUN_LAST,
                                                    0, NULL, NULL,
                                                    _expidus_settings_marshal_VOID__STRING_BOXED,
                                                    G_TYPE_NONE, 2,
                                                    G_TYPE_STRING,
                                                    G_TYPE_VALUE);
    ...
    g_value_register_transform_func (G_TYPE_STRV, G_TYPE_STRING,
                                     expidus_settings_strv_to_string);
}



static void
expidus_settings_cell_renderer_init (ExpidusSettingsCellRenderer *renderer)
{
...
static void
expidus_settings_cell_renderer_set_property (GObject      *object,
                                          guint         prop_id,
                                          const GValue *value,
                                          GParamSpec   *pspec)
{
    ExpidusSettingsCellRenderer *renderer = EXPIDUS_SETTINGS_CELL_RENDERER (object);
    GValue                   *real_value;
...
static void
expidus_settings_cell_renderer_get_property (GObject    *object,
                                          guint       prop_id,
                                          GValue     *value,
                                          GParamSpec *pspec)
{
...
static void
expidus_settings_cell_renderer_finalize (GObject *object)
{
    ExpidusSettingsCellRenderer *renderer = EXPIDUS_SETTINGS_CELL_RENDERER (object);
    ...
    G_OBJECT_CLASS (expidus_settings_cell_renderer_parent_class)->finalize (object);
}



static GtkCellRenderer *
expidus_settings_cell_renderer_prepare (ExpidusSettingsCellRenderer *renderer)
{
    const GValue *value = &renderer->cell_value;
    GValue        str_value = { 0, };

    if (G_VALUE_TYPE (value) == expidus_settings_array_type ()
...
static void
expidus_settings_cell_renderer_render (GtkCellRenderer      *cell,
                                    cairo_t              *cr,
                                    GtkWidget            *widget,
                                    const GdkRectangle   *background_area,
                                    const GdkRectangle   *cell_area,
                                    GtkCellRendererState  flags)
{
    ExpidusSettingsCellRenderer *renderer = EXPIDUS_SETTINGS_CELL_RENDERER (cell);
    GtkCellRenderer          *cell_renderer;

    cell_renderer = expidus_settings_cell_renderer_prepare (renderer);
...
static gint
expidus_settings_cell_renderer_activate (GtkCellRenderer      *cell,
                                      GdkEvent             *event,
                                      GtkWidget            *widget,
                                      const gchar          *path,
                                      const GdkRectangle   *background_area,
...
static void
expidus_settings_cell_renderer_done_editing (GtkCellEditable          *entry,
                                          ExpidusSettingsCellRenderer *renderer)
{
    EditData    *data;
    const gchar *text;
    GValue       value = { 0, };
...
static void
expidus_settings_cell_renderer_edit_free (gpointer user_data)
{
...
expidus_settings_cell_renderer_start_editing (GtkCellRenderer      *cell,
                                           GdkEvent             *event,
                                           GtkWidget            *widget,
                                           const gchar          *path,
                                           const GdkRectangle   *background_area,
        ...
        case G_TYPE_STRING:
            ...
            if (g_value_transform (&renderer->cell_value, &str_value))
            {
                ...
                g_object_set_qdata_full (G_OBJECT (entry), edit_data_quark, data,
                    expidus_settings_cell_renderer_edit_free);

                g_signal_connect (G_OBJECT (entry), "editing-done",
                    G_CALLBACK (expidus_settings_cell_renderer_done_editing), cell);
...
static void
expidus_settings_array_to_string (const GValue *src_value,
                               GValue       *dest_value)
{
    GString      *str;
...
static void
expidus_settings_strv_to_string (const GValue *src_value,
                              GValue       *dest_value)
{
...
GtkCellRenderer *
expidus_settings_cell_renderer_new (void)
{
    return g_object_new (EXPIDUS_TYPE_SETTINGS_CELL_RENDERER, NULL);
}



GType
expidus_settings_array_type (void)
{
    static GType type = 0;
    ...
    if (type == 0)
    {
        ...
        g_value_register_transform_func (type, G_TYPE_STRING,
                                         expidus_settings_array_to_string);
    }
